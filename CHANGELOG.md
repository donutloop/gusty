...
- Union-type syntax: `int | str` in annotations parses as a union type and drives gradual assignability (a value assignable to any member is accepted; one outside every member is reported). (L5.5)
