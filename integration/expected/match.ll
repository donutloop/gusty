...
match.case2:
  %t2 = call i32 @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.fmt1, i32 0, i32 0), i32 1)
  br label %match.end1
match.next3:
  %t3 = icmp eq i32 %_x.ld1, 2
  br i1 %t3, label %match.case4, label %match.end1
match.case4:
  %t4 = call i32 @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.fmt2, i32 0, i32 0), i32 2)
  br label %match.end1
match.end1:
  ret i32 0
}
